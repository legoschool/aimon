...
const QUESTIONS = [
  /* ================= ⚖️ 저작권 ================= */
  {
    ...
    question: "이 글을 어떻게 하는 것이 좋을까?",
    options: [
      "그대로 내 이름으로 제출한다.",
      "몇 문장만 바꿔서 제출한다.",
      "내가 느낀 점을 직접 쓰고, 막힐 때만 AI에게 도움을 받는다.",
      "AI가 썼다고 적어 두고 그대로 제출한다.",
    ],
    answer: 2,
  ...
  },
  {
    ...
    situation: "우리 반 활동을 찍어 영상으로 만들었다. 좋아하는 가수의 노래를 배경음악으로 깔고 싶다.",
    question: "어떻게 하는 것이 좋을까?",
    options: [
      "짧게 몇 초만 넣으면 괜찮다.",
      "노래 제목과 가수 이름을 적어 두면 괜찮다.",
      "자유롭게 쓸 수 있는 음악을 찾거나, 직접 만든 소리를 쓴다.",
      "우리 반만 볼 영상이니 그냥 넣는다.",
    ],
    answer: 2,
    explanation: "노래에도 만든 사람이 있어요. 짧게 넣거나 제목을 적어 두는 것으로 허락을 받은 게 되지는 않아요. '마음껏 써도 된다'고 표시된 음악을 찾아 쓰면 마음이 편합니다.",
  ...
  },
  {
    ...
    options: [
      "재미로 해 보는 거니까 그냥 넣는다.",
      "만들어서 친구에게 보여 주고, 웃으면 괜찮다.",
      "넣기 전에 친구에게 물어보고, 싫다고 하면 넣지 않는다.",
      "얼굴을 조금 가려서 넣는다.",
    ],
    answer: 2,
  ...
  },
  {
    ...
    options: [
      ...
      "게임에 내 위치가 왜 필요한지 따져 보고, 필요 없어 보이면 거절한다.",
      "일단 허용하고 나중에 끄면 된다.",
      "부모님 몰래 허용한다.",
    ],
    answer: 1,
  ...
  },
  {
    ...
    options: [
      "이렇게 많이 나오는 걸 보니 그 말이 맞는 것 같다.",
      "일부러 다른 의견의 영상도 찾아보고 견주어 본다.",
      "추천이 뜨는 대로 계속 본다.",
      "친구들에게도 공유한다.",
    ],
    answer: 1,
  ...
  },
  {
    ...
    options: [
      "사진이 있으니 진짜 있는 사람이다.",
      "AI가 만든 사진일 수 있으니, 진짜인지 확인하기 전에는 믿지 않는다.",
      "화질이 나빠서 그렇게 보인 것이다.",
      "친구들에게 물어보고 많은 쪽을 믿는다.",
    ],
    answer: 1,
