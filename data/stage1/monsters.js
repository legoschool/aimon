/* ===========================================================
   ...
   가치몬은 그림자몬과 같은 실루엣을 쓴다. 세부만 바뀌므로
...
MONSTERS.push(
  /* ========== ⚖️ 저작권 ========== */
  {
    ...
    purified: {
      ...
      lesson: "베낀 글은 아무리 예뻐도 내 글이 아니에요. 내 말로 바꾸고 어디서 봤는지 적어두면 떳떳하게 쓸 수 있는 자료가 됩니다.",
      sprite: [
        "................",
        "...kkkkkkkk.....",
        "...kwwwwwwk.....",
  ...
  /* ========== 🤝 개인정보 ========== */
  {
    ...
    purified: {
      ...
      lesson: "사진 속 얼굴에도 주인이 있어요. 올리기 전에 '이거 올려도 돼?' 하고 묻고, 친구가 괜찮다고 할 때만 올립니다.",
      sprite: [
        "................",
        "..kkkkkkkkkkkk..",
        "..kwwwwwwwwwwk..",
...

  {
    ...
    purified: {
      id: "bimil",
      name: "비밀지기",
      desc: "꼭 필요한 정보만 넣는 습관.",
      lesson: "챗봇에 적은 말은 회사에 저장되어 남을 수 있어요. 이름·학교·주소는 넣지 않아도 대부분 답을 받을 수 있습니다.",
      sprite: [
        "................",
        "..kkkkkkkkkkkk..",
        "..kwwwwwwwwwwk..",
  ...
  /* ========== 🔍 허위정보 ========== */
  {
    ...
    level: 7,
    maxGrip: 80,
    desc: "AI가 지어낸 틀린 정보를 그럴싸하게 꾸며 진짜처럼 퍼뜨린다.",
    ...
    purified: {
      ...
      lesson: "AI는 모를 때도 아는 척을 해요. 한 곳에서만 본 정보는 아직 사실인지 알 수 없습니다.",
      sprite: [
        "................",
        "....kkkkkkkk....",
        "..kkwwwwwwwwkk..",
