    ...
    [
      {
        title: "판단 도구 고르기",
        text:
          "아래 <b>판단 도구 4개</b> 중 하나를 고르면, 그 도구에 맞는 문제가 나와요.<br><br>" +
          "🔍 출처확인 · ⚖️ 권리존중 · 🤝 책임사용 · 🧠 비판적사고",
      },
      {
      ...
      },
      {
        ...
        text:
          ...
          "🧠 비판적사고는 틀려도 절반만 깎이니, 모를 땐 이걸 고르세요.",
        done: "해볼게요!",
      },
    ],
    onDone
    ...
    [
      {
        ...
        text:
          "두 가지를 모두 채워야 던질 수 있어요.<br><br>" +
          "① 몬스터의 <b>장악력이 30% 이하</b><br>" +
          "② 내 <b>정답률이 60% 이상</b><br><br>" +
